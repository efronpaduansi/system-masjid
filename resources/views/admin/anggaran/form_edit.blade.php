...
<div class="col-md-12">
    <div class="tile">
      ...
      <div class="tile-body">
        <form class="form-horizontal" action="{{ route('anggaran.update', $anggaran->id) }}" method="POST" id="myForm">
            @csrf
            @method('PUT')
            <div class="form-group row">
                <label class="control-label col-md-3">Nama Anggaran <small class="text-danger">*</small></label>
                <div class="col-md-4">
                    <input class="form-control" type="text" name="name" placeholder="Masukan nama anggaran" value="{{ $anggaran->name }}">
                </div>
            </div>
            <div class="form-group row">
                <label class="control-label col-md-3">Deskripsi</label>
                <div class="col-md-9">
                <textarea class="form-control" name="description" rows="4" placeholder="Masukan deskripsi">{{ $anggaran->description }}</textarea>
                </div>
            </div>
            <div class="form-group row">
                <label class="control-label col-md-3">Jumlah Dana Anggaran <small class="text-danger">*</small></label>
                <div class="col-md-4">
                    <input type="text" name="amount" id="amount" class="form-control" placeholder="Masukan jumlah" value="{{ $anggaran->amount }}">
                </div>
            </div>
            <div class="form-group row">
