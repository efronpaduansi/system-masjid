...
@section('content')
    <div class="col-md-12">
        <div class="tile">
            ...
            <div class="tile-body">
                <form class="form-horizontal" action="{{ route('material.update', $material->id) }}" method="POST"
                    id="myForm">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" name="code" value="{{ $material->code }}"
                                readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-3">Master Pembangunan <small
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" name="name" placeholder="Masukan nama material"
                                value="{{ $material->name }}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <select name="unit" id="unit" class="form-control">
                                <option value="{{ $material->unit }}" disabled selected hidden>{{ $material->unit }}
                                </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="unit_price" id="unit_price" class="form-control"
                                placeholder="Masukan harga" value="{{ $material->unit_price }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="amount" id="amount" class="form-control"
                                placeholder="Masukan jumlah" value="{{ $material->amount }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-3">
                                <button class="btn btn-primary" type="submit" id="submitBtn"
                                    onclick="validate()">Simpan</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary"
                                    href="{{ route('material.index') }}">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
