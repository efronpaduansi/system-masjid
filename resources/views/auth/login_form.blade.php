...
@section('auth-box')
<div class="login-box">
    <form class="login-form" id="loginForm" action="{{ route('auth.do_login') }}" method="POST">
      @csrf
      @method('POST')
      <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>SIGN IN</h3>
      <div class="form-group">
        <label class="control-label">E-MAIL</label>
        <input class="form-control" type="text" name="email" placeholder="Email" autofocus autocomplete="off" value="{{ old('email') }}">
      </div>
      <div class="form-group">
